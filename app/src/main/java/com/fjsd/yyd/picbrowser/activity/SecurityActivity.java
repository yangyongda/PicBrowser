...
public class SecurityActivity extends ThemedActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        toggleEnabledChild(securityObj.isActiveSecurity());  //根据是否打开开关来决定是否显示子菜单
    ...
    private void setPasswordDialog() {
        ...
        dialog.setButton(DialogInterface.BUTTON_POSITIVE, getString(R.string.ok_action).toUpperCase(), new DialogInterface.OnClickListener() {
            @Override
